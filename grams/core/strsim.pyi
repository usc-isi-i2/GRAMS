...
def levenstein_similarity(s1: VecChar, s2: VecChar) -> float: ...
def jaro_similarity(s1: VecChar, s2: VecChar) -> float: ...
def jaro_winkler_similarity(s1: VecChar, s2: VecChar, threshold = 0.7, scaling_factor = 0.1, prefix_len = 4) -> float: ...
