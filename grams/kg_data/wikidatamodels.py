...
class WDClass:
    ...
    @staticmethod
    def from_file(indir: str, load_parent_closure: bool = False) -> Dict[str, 'WDClass']:
...
class WDProperty:
    ...
    @staticmethod
    def from_file(indir: str, load_parent_closure: bool = False, filename="properties.jl") -> Dict[str, 'WDProperty']:
        records = M.deserialize_jl(os.path.join(indir, filename))
        records = [WDProperty(**c) for c in records]
        for r in records:
            r.parents_closure = set(r.parents_closure)
...
class WDQuantityPropertyStats:
    ...
    @staticmethod
    def from_dir(indir: str) -> Dict[str, 'WDQuantityPropertyStats']:
        odict = {}
