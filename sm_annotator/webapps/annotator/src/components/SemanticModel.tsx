...
import AddEdgeForm from "./sm/AddEdgeForm";
import AddNodeForm from "./sm/AddNodeForm";
import EditClassNodeForm from "./sm/EditClassNodeForm";
import EditDataNodeForm from "./sm/EditDataNodeForm";
import EditEdgeForm from "./sm/EditEdgeForm";
import { EditLiteralNodeForm } from "./sm/EditLiteralNodeForm";
import { G6Graph } from "./sm/Graph";
...
@observer
export default class SemanticModel extends React.Component<Props, State> {
